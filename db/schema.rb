...
ActiveRecord::Schema.define(version: 20160413120220) do
  ...
  add_index "favorite_employees", ["person_id"], name: "index_favorite_employees_on_person_id", using: :btree
  add_index "favorite_employees", ["user_id"], name: "index_favorite_employees_on_user_id", using: :btree
  ...
  add_foreign_key "favorite_employees", "people"
  add_foreign_key "favorite_employees", "users"
